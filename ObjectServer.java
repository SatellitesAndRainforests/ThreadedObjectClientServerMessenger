		...
		public void run() {
			try {
				...
				while (running) {
					...
					System.out.println("Object received from " + clientSocket.getRemoteSocketAddress());
		...
		try { 
			...
			while (running) {
				try {
					...
					System.out.println("Made connection to server	: " + clientSocket.getRemoteSocketAddress());
